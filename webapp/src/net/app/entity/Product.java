...
import net.app.BigDecimalNumericFieldBridge;
...
public class Product extends BaseEntity {
	...
	static {
		try {
			...
			org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/webapp/template[@id='productContent']");
	...
	public String getPhonePath() {
		return "/product/phone/"+getId()+".html";
	}
	/**
	 * 获取缩略图
	 * 
