...
import net.app.Filter.Operator;
import net.app.Order.Direction;
import net.app.dao.BaseDao;
import net.app.entity.OrderEntity;
	...
	private synchronized String getAlias(Selection<?> selection) {
		if (selection != null) {
			...
			if (alias == null) {
				...
				alias = "webappGeneratedAlias" + aliasCount++;
