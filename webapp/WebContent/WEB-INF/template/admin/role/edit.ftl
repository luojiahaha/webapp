...
<title>${message("admin.role.edit")} - Powered By LFX</title>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:test"[#if role.authorities?seq_contains("admin:test")] checked="checked"[/#if] />${message("admin.role.test")}
						</label>
					</span>
				</td>
			</tr>
