...
<%@page import="net.app.Setting"%>
<%@page import="net.app.util.SettingUtils"%>
<%@page import="net.app.util.SpringUtils"%>
<%@page import="net.app.Setting.CaptchaType"%>
<%@page import="net.app.Setting.AccountLockType"%>
<%@page import="net.app.service.RSAService"%>
...
%>
<title><%=SpringUtils.getMessage("admin.login.title")%> - Powered By LFX</title>
...
<%} else {%>
<title>提示信息 - Powered By LFX</title>
<meta http-equiv="expires" content="0" />
<meta http-equiv="Pragma" content="no-cache" />
<meta http-equiv="Cache-Control" content="no-cache" />
<meta name="author" content="LFX Team" />
...
<body>
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/resources/admin/images/login_logo.gif" alt="LFX" />
						</td>
						<th>
	...
	<%} else {%>
		<fieldset>
			...
			<p>请检查LFX程序是否已正确安装 [<a href="<%=base%>/install/">点击此处进行安装</a>]</p>
			<p>
				<strong>提示: LFX安装完成后必须重新启动WEB服务器</strong>
			</p>
		</fieldset>
	<%}%>
</body>
